...
class EditProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final streamgramUser = context
        .select<AppState, StreamgramUser?>((value) => value.streamgramUser);
          ...
          SizedBox(
            ...
            child: Center(
              child: isUploadingProfilePicture
                ...
                child: Avatar.huge(streamgramUser: streamgramUser),
              ),
            ),
          ),
          GestureDetector(
