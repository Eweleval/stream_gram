...
import 'package:stream_gram/components/profile/edit_profile_screen.dart';
...
class _ProfileHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final streamgramUser = feedState.streamgramUser;
    if (streamgramUser == null) return const SizedBox.shrink();
    return Column(
      children: [
        Row(
          children: [
        ...
        Align(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(streamgramUser.fullName,
