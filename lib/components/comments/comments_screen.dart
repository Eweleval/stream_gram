...
class CommentsScreen extends StatefulWidget {
  ...
  final StreamgramUser activityOwnerData;

  /// MaterialPageRoute to this screen.
  static Route route({
    required EnrichedActivity enrichedActivity,
    required StreamgramUser activityOwnerData,
  }) =>
      MaterialPageRoute(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CommentBox(
              commenter: context.appState.streamgramUser!,
...
class __CommentTileState extends State<_CommentTile> {
  late final userData = StreamgramUser.fromMap(widget.reaction.user!.data!);
          ...
          children: [
            Padding(
              ...
              child: (widget.isReplyToComment)
                  ? Avatar.tiny(streamgramUser: userData)
                  : Avatar.small(streamgramUser: userData),
            ),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
