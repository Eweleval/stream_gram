...
import 'package:stream_gram/components/profile/profile.dart';
import 'package:stream_gram/components/search/search_page.dart';
import 'package:stream_gram/components/timeline/timeline_page.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:
        Text('Stream-gram', style: GoogleFonts.grandHotel(fontSize: 32)),
        elevation: 0,
        centerTitle: false,
        actions: [
          Padding(
      ...
      bottomNavigationBar: _StreamgramBottomNavBar(
...
class _StreamgramBottomNavBar extends StatefulWidget {
  const _StreamgramBottomNavBar({
    Key? key,
  ...
  @override
  State<_StreamgramBottomNavBar> createState() =>
      _StreamgramBottomNavBarState();
}

class _StreamgramBottomNavBarState extends State<_StreamgramBottomNavBar> {
