...
class PostCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final userData = StreamgramUser.fromMap(actorData as Map<String, dynamic>);
              ...
              onTap: () {
                ...
                Navigator.of(context).push(
                  CommentsScreen.route(
                    ...
                    activityOwnerData: StreamgramUser.fromMap(map),
                  ),
                );
              },
...
class _ProfilePicture extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final streamgramUser = context.watch<AppState>().streamgramUser;
    if (streamgramUser == null) {
      return const Icon(Icons.error);
    }
    return Avatar.small(
      streamgramUser: streamgramUser,
    );
  }
}
...
class _ProfileSlab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Avatar.medium(streamgramUser: userData),
          Padding(
